...
export class ValidateInstrumentsDto {
  ...
  @ApiPropertyOptional({
    description:
      'Filter by high-level instrument type (maps to multiple instrument_name codes)',
    example: 'EQUITIES',
  ...
  @ApiPropertyOptional({
    description:
      'If true, include full list of invalid instruments in response',
    example: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Cap the total number of instruments processed (optional)',
    example: 2000,
  })
  @IsOptional()
  @Transform(({ value }) => Number(value))
