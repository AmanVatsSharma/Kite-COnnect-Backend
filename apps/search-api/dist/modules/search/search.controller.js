...
let SearchController = class SearchController {
    ...
    async search(dto, adminTokenHeader) {
        ...
        const filters = {
            ...
            strike_min: parsed.strike !== undefined ? parsed.strike : dto.strike_min,
            strike_max: parsed.strike !== undefined ? parsed.strike : dto.strike_max,
    ...
    async filters(exchange, segment, instrumentType, assetClass) {
        ...
        if (raw.streamProvider) {
            ...
            for (const [k, v] of Object.entries(raw.streamProvider)) {
                mapped[(0, provider_aliases_1.internalToPublicProvider)(k)] =
                    v;
            }
