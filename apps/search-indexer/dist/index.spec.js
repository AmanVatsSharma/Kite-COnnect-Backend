...
describe('indexer enrichment helpers', () => {
    it('lastThursdayOfMonth returns 25 for Jan 2024 (last Thursday = 25th)', () => {
        expect((0, index_helpers_1.lastThursdayOfMonth)(2024, 1)).toBe(25);
    });
    it('lastThursdayOfMonth returns 30 for May 2024 (last Thursday = 30th)', () => {
        expect((0, index_helpers_1.lastThursdayOfMonth)(2024, 5)).toBe(30);
    });
    it('lastThursdayOfMonth returns 28 for March 2024 (last Thursday = 28th)', () => {
        expect((0, index_helpers_1.lastThursdayOfMonth)(2024, 3)).toBe(28);
    });
    it('weekOfMonth returns 1 for the 1st-7th, 2 for 8th-14th, etc.', () => {
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 1)).toBe(1);
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 7)).toBe(1);
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 8)).toBe(2);
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 14)).toBe(2);
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 15)).toBe(3);
        expect((0, index_helpers_1.weekOfMonth)(2024, 6, 30)).toBe(5);
    });
});
