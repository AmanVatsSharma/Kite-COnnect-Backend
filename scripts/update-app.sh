...
echo "  - SSL/HTTPS: ${GREEN}Preserved${NC} (Nginx untouched)"
echo ""
echo "Backup location: $BACKUP_DIR"
echo ""
echo "Useful commands:"
echo "  View logs: docker logs -f trading-app-backend"
echo "  Check health: curl https://marketdata.vedpragya.com/api/health"
echo "  View services: docker compose ps"
echo "  Check SSL: ./scripts/check-ssl-health.sh"
echo ""
